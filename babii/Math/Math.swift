...
func perspective(fovyRadians: Float, aspect: Float, nearZ: Float, farZ: Float) -> matrix_float4x4 {
...
func lookAt(position: SIMD3<Float>, target: SIMD3<Float>, up: SIMD3<Float>) -> matrix_float4x4 {
...
func translation(vector: SIMD3<Float>) -> matrix_float4x4 {
...
func rotation(angle: Float, vector: SIMD3<Float>) -> matrix_float4x4 {
    let c = cos(angle)
    let s = sin(angle)
    let d = 1 - c
